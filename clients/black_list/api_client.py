...
import clients.black_list.models
from clients.black_list import rest
from clients.black_list.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clients.black_list.models, klass)
